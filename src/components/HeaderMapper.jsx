...
const HeaderMapper = ({
  ...
  return (
    <div className='header-mapper'>
      <p>
        Match the columns from the CSV file to the corresponding fields. If any
        fields are missing, you can create them in the Fields section.
      </p>
      {data[0].map((header, columnIndex) => {
        ...
        const fieldStatistics = {
          ...
          statistics:
            statistics.statisticsByFieldKey[headerMapping.selectedField?.value]
        }
        return (
          <HeaderMapperRow
            Select={Select}
