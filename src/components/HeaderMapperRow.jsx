  ...
  return (
    <div className='statistics'>
      <div>
        ...
        <span>
          {percentage(total - counts.isNull, total)}% of your rows have a value
          for this column
        </span>
      </div>
      ...
      {errorTypeCounts.total > 0 && (
        <div>
          ...
          {errorTypeCounts.total / total < 0.02 && (
            <span>
              <b>{errorTypeCounts.total}</b> rows fail validation. You can
              repair it on next step.
            </span>
          )}
          {errorTypeCounts.total / total >= 0.02 && (
            <span>
              <b>{percentage(errorTypeCounts.total, total)}%</b> of rows fail
              validation. You can repair it on next step.
            </span>
          )}
        </div>
      )}
